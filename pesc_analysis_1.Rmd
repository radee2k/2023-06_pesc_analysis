...
```{r most_diff_bar1, fig.width=15, fig.height=10}
setDT(c_markers)
...
```{r cluster_heatmap1, cache = T, fig.width= 15, fig.height= 15}
...
```{r cells2 DEseq - low min.pct, cache = T, message = F, error = F, warning=F}
...
Plot most differentially expressed genes
```{r most_diff_bar_2, fig.width=15, fig.height=10}
setDT(c_markers2)
...
```{r cluster_heatmap_2, cache = T, fig.width= 15, fig.height= 15}
...
```{r cells2 DE wilcox, cache = T, message = F, warning=F, error=F}
...
Plot most differentially expressed genes
```{r most_diff_bar_3, fig.width=15, fig.height=10}
setDT(c_markers3)
...
```{r cluster_heatmap_3, cache = T, fig.width= 15, fig.height= 18}
