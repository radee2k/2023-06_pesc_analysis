...
Data allows to correctly stratify cells, accordingly to their origin and diagnosis.

```{r, cache = T, fig.width= 15, fig.height= 5, dev='svglite'}
...
```{r, cache = T, fig.width= 7, fig.height= 5, dev='svglite', eval = F}
...
```{r, cache = T, fig.width= 7, fig.height= 5, dev='svglite'}
ElbowPlot(ds_cf)
```
...
```{r, cache = T, fig.width= 10, fig.height= 5, dev='svglite'}
...
```{r, cache = T, fig.width= 15, fig.height= 10, dev='svglite'}
...
### Find cell clusters 
```{r, cache = T, fig.width= 10, fig.height= 10, dev='svglite'}
