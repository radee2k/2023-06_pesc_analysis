...
### Find cell clusters 
```{r clustering_cells_umap, fig.height=15, fig.width=15, cache=TRUE}
...
**Clustering doesn't seem to provide any useful information - data is further explored to exclude possible confounding effects in data quality**
