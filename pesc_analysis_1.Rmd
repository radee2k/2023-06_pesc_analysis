...
author:
- name: Radoslaw Grochowski
  affiliation: Karolinska Institutet, Department of Laboratory Medicine
output:
  html_document:
    theme:
      bg: "#444444"
...
```{r Main QC plots, cache=TRUE, fig.width=10, dev='svg'}
...
```{r most expressed, cache = T, dev='svg'}
...
```{r, fig.width= 15, cache = T, dev='svg'}
...
```{r, cache = T, fig.width=15, fig.height=10, dev='svg'}
...
```{r, fig.width=15, fig.height=10, dev='svg'}
...
QC plotting of filtered reads ---- percentages
