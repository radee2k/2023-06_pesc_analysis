...
```{r correlation of PCs with metadata, fig.width= 15, cache = T}
...
```{r dim_heatmap_cells_2, cache = T, fig.width= 15, fig.height= 20}
...
#### PC1 of each patient.
```{r dim_heatmap_cells_patients_2, cache = T, fig.width= 15, fig.height= 15}
plot_pat_dim_heat <- function (data, patient) {
