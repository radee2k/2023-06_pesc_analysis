...
```{r Main QC plots, cache=TRUE, fig.width=15, fig.height=25, dev='svglite'}
...
```{r most expressed cells, fig.width=10, cache = T, dev='svglite'}
...
```{r, fig.width=10, cache = T, dev='svglite'}
...
```{r, fig.width= 15, fig.height=5, cache = T, dev='svglite'}
...
```{r, fig.width=15, fig.height=25, cache = T, dev='svglite'}
...
```{r, fig.width=10, fig.height=5, cache = T, dev='svglite'}
...
```{r most expressed, fig.width=10, cache = T, dev='svglite'}
...
```{r }
FeatureScatter(ds_dcf, "nCount_RNA", "nFeature_RNA", pt.size = 1, plot.cor = F) + scale_x_continuous(labels = scales::scientific)
```
